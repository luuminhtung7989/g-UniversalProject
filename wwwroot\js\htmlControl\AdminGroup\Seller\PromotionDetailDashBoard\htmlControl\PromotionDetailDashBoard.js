var _gbSubDictionary = {
	PromotionDetailDashBoard : {
		...
		_fieldsList: [
			...
			/*2*/{ field: "PromotionID", name: "PromotionID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:{obj:"undefined", fcol:"undefined}"}, option:{ field: "PromotionID", mergename: [1], objAjax: { AjaxObj: { a: "fGetPromotions", c: { }, _f: "Id,Id", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }},
