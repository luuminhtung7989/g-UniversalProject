var _gbSubDictionary = {
	PromotionDashBoard : {
		...
		_fieldsList: [
			...
			/*3*/{ field: "TotalDelivered", name: "TotalDelivered", create: true, edit: true, list: true, type: "double",  expandtype:"" },
			/*4*/{ field: "Income", name: "Income", create: true, edit: true, list: true, type: "double",  expandtype:"" },
			/*5*/{ field: "Expense", name: "Expense", create: true, edit: true, list: true, type: "double",  expandtype:"" },
