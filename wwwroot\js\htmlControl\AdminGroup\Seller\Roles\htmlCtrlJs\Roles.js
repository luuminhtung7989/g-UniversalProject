var _gbSubDictionary = {
	Roles : {
		...
		_fieldsList: [
			...
			/*1*/{ field: "UserID", name: "UserID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:{obj:"undefined", fcol:"undefined}"}, option:{ field: "UserID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetUsers", c: { }, _f: "Id,Email,Phone", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }},
			/*2*/{ field: "GroupRightID", name: "GroupRightID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:{obj:"undefined", fcol:"undefined}"}, option:{ field: "GroupRightID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetGroupRights", c: { }, _f: "Id,Name,Code", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }},
