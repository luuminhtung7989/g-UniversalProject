var _gbSubDictionary = {
	Logins : {
		...
		_listReports: [{}],
		_listSelfTables: [
			{ AjaxObj: { a: "fGetLogins", _f: "*", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetLogins", _f: "Id,TimeLogin,TimeLogout,UpdatedTime,TotalTimes,UserID,Online,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetLogins", _f: "Id,TimeLogin,TimeLogout,UpdatedTime,TotalTimes,UserID,Online,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
		],
		_listRefTables: [
		...
		_fieldsList: [
			...
			/*1*/{ field: "TimeLogin", name: "TimeLogin", create: true, edit: true, list: true, type: "datetime",  expandtype:"" , allownull:false},
			/*2*/{ field: "TimeLogout", name: "TimeLogout", create: true, edit: true, list: true, type: "datetime",  expandtype:"" , allownull:false},
			/*3*/{ field: "UpdatedTime", name: "UpdatedTime", create: true, edit: true, list: true, type: "datetime",  expandtype:"" , allownull:false},
			/*4*/{ field: "TotalTimes", name: "TotalTimes", create: true, edit: true, list: true, type: "double",  expandtype:"" , allownull:false},
			/*5*/{ field: "UserID", name: "UserID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "UserID", mergename: [1], objAjax: { AjaxObj: { a: "fGetUsers", c: { }, _f: "Id,UseName",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:true},
			/*6*/{ field: "Online", name: "Online", create: true, edit: true, list: true, type: "int",  expandtype:"" , allownull:false},
		...
		_fieldsSearch: [
			...
			/*1*/{ field: "TimeLogin", name: "TimeLogin", create: true, edit: true, list: true, type: "datetime",  expandtype:"" , allownull:false,search:""},
			/*2*/{ field: "TimeLogout", name: "TimeLogout", create: true, edit: true, list: true, type: "datetime",  expandtype:"" , allownull:false,search:""},
			/*3*/{ field: "UpdatedTime", name: "UpdatedTime", create: true, edit: true, list: true, type: "datetime",  expandtype:"" , allownull:false,search:""},
			/*4*/{ field: "TotalTimes", name: "TotalTimes", create: true, edit: true, list: true, type: "double",  expandtype:"" , allownull:false,search:""},
			/*5*/{ field: "UserID", name: "UserID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "UserID", mergename: [1], objAjax: { AjaxObj: { a: "fGetUsers", c: { }, _f: "Id,UseName",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:true,search:""},
			/*6*/{ field: "Online", name: "Online", create: true, edit: true, list: true, type: "int",  expandtype:"" , allownull:false,search:""},
