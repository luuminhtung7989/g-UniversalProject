var _gbSubDictionary = {
	BusinessLanguages : {
		...
		_listReports: [{}],
		_listSelfTables: [
			{ AjaxObj: { a: "fGetBusinessLanguages", _f: "*", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetBusinessLanguages", _f: "Id,BusinessID,LanguageID,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetBusinessLanguages", _f: "Id,BusinessID,LanguageID,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
		],
		_listRefTables: [
			...
			{ field: "LanguageID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetLanguages", c: { }, _f: "Id,Name,Code",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } },
		...
		_fieldsList: [
			...
			/*2*/{ field: "LanguageID", name: "LanguageID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "LanguageID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetLanguages", c: { }, _f: "Id,Name,Code",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:true},
		...
		_fieldsSearch: [
			...
			/*2*/{ field: "LanguageID", name: "LanguageID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "LanguageID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetLanguages", c: { }, _f: "Id,Name,Code",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:true,search:""},
