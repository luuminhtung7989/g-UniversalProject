var _gbSubDictionary = {
	BusinessLanguages : {
		...
		_listRefTables: [
			...
			{ field: "LanguageID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetLanguages", c: { }, _f: "Id,Name,Code", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }
		],
		_fieldsList: [
			...
			/*2*/{ field: "LanguageID", name: "LanguageID", create: true, edit: true, list: true, type: "bigint",  expandtype:"" , option:{ field: "LanguageID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetLanguages", c: { }, _f: "Id,Name,Code", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }},
