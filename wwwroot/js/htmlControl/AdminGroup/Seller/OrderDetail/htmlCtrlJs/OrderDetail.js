var _gbSubDictionary = {
	OrderDetail : {
		...
		_listReports: [{}],
		_listSelfTables: [
			{ AjaxObj: { a: "fGetOrderDetail", exV:"view_ListOrderDetail", _f: "*", _gb: " ORDER BY OrderID, ServicesID, StaffID", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
		...
		_fieldsList: [
			...
			/*1*/{ field: "ServicesID", name: "ServicesID", create: true, edit: true, list: true, type: "bigint",  expandtype:"" , option:{ field: "ServicesID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetServices", c: { }, _f: "Id,Name,Code", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }},
			/*2*/{ field: "OrderID", name: "OrderID", create: true, edit: true, list: true, type: "bigint",  expandtype:"" , option:{ field: "OrderID", mergename: [1], objAjax: { AjaxObj: { a: "fGetOrders", c: { }, _f: "Id,Id", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }},
			/*3*/{ field: "StaffID", name: "StaffID", create: true, edit: true, list: true, type: "bigint",  expandtype:"" , option:{ field: "StaffID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetStaff", c: { }, _f: "Id,Name,Phone", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }},
		...
		_fieldsReportList: [
			...
			/*10*/{ field: "StaffName", name: "StaffName", create: true, edit: true, list: true, type: "string",  expandtype:"" },
			/*10*/{ field: "ServicesName", name: "ServicesName", create: true, edit: true, list: true, type: "string",  expandtype:"" },
		],
		_fieldsReportList: [
			/*0*/{ field: "Id", name: "Identify", create: true, edit: true, list: true, type: "bigint",  expandtype:"hidden" },
			/*1*/{ field: "ServicesID", name: "ServicesID", create: true, edit: true, list: true, type: "bigint",  expandtype:"" , option:{ field: "ServicesID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetServices", c: { }, _f: "Id,Name,Code", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }},
	...
	Orders : {
		...
		_fieldsList: [
			/*0*/{ field: "Id", name: "Identify", create: true, edit: true, list: true, type: "bigint",  expandtype:"hidden" },
			/*1*/{ field: "BusinessID", name: "BusinessID", create: true, edit: true, list: true, type: "bigint",  expandtype:"" , option:{ field: "BusinessID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetBusiness", c: { }, _f: "Id,Name,Phone", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }},
			/*2*/{ field: "CustomerID", name: "CustomerID", create: true, edit: true, list: true, type: "bigint",  expandtype:"" , option:{ field: "CustomerID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetCustomers", c: { }, _f: "Id,Name,Phone", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }},
