var _gbSubDictionary = {
	BusinessPolycies : {
		...
		_listReports: [{}],
		_listSelfTables: [
			{ AjaxObj: { a: "fGetBusinessPolycies", _f: "*", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetBusinessPolycies", _f: "Id,Description,OrtherPolices,BusinessID,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetBusinessPolycies", _f: "Id,Description,OrtherPolices,BusinessID,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
		],
		_listRefTables: [
		...
		_fieldsList: [
			...
			/*1*/{ field: "Description", name: "Description", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*2*/{ field: "OrtherPolices", name: "OrtherPolices", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
		...
		_fieldsSearch: [
			...
			/*1*/{ field: "Description", name: "Description", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*2*/{ field: "OrtherPolices", name: "OrtherPolices", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
