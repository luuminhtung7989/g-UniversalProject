var _gbSubDictionary = {
	BusinessPolycies : {
		...
		_fieldsList: [
			...
			/*1*/{ field: "Description", name: "Description", create: true, edit: true, list: true, type: "string",  expandtype:"" },
			/*2*/{ field: "OrtherPolices", name: "OrtherPolices", create: true, edit: true, list: true, type: "string",  expandtype:"" },
