var _gbSubDictionary = {
	StaffServives : {
		...
		_listReports: [{}],
		_listSelfTables: [
			{ AjaxObj: { a: "fGetStaffServives", _f: "*", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetStaffServives", _f: "Id,StaffID,ServicesID,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetStaffServives", _f: "Id,StaffID,ServicesID,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
		],
		_listRefTables: [
			...
			{ field: "ServicesID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetServices", c: { }, _f: "Id,Name,Code",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } },
		...
		_fieldsList: [
			...
			/*2*/{ field: "ServicesID", name: "ServicesID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "ServicesID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetServices", c: { }, _f: "Id,Name,Code",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:true},
		...
		_fieldsSearch: [
			...
			/*2*/{ field: "ServicesID", name: "ServicesID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "ServicesID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetServices", c: { }, _f: "Id,Name,Code",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:true,search:""},
