var _gbSubDictionary = {
	TicketSetting : {
		...
		_fieldsList: [
			...
			/*1*/{ field: "FieldName", name: "FieldName", create: true, edit: true, list: true, type: "string",  expandtype:"" },
			/*2*/{ field: "FormName", name: "FormName", create: true, edit: true, list: true, type: "string",  expandtype:"" },
			/*3*/{ field: "TableName", name: "TableName", create: true, edit: true, list: true, type: "string",  expandtype:"" },
			/*4*/{ field: "Ordered", name: "Ordered", create: true, edit: true, list: true, type: "string",  expandtype:"" },
			/*5*/{ field: "BusinessID", name: "BusinessID", create: true, edit: true, list: true, type: "bigint",  expandtype:"" , option:{ field: "BusinessID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetBusiness", c: { }, _f: "Id,Name,Phone", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }},
