var _gbSubDictionary = {
	GroupRightDetail : {
		...
		_fieldsList: [
			...
			/*1*/{ field: "GroupID", name: "GroupID", create: true, edit: true, list: true, type: "bigint",  expandtype:"" },
			/*2*/{ field: "ParentGroupID", name: "ParentGroupID", create: true, edit: true, list: true, type: "bigint",  expandtype:"" },
			/*3*/{ field: "subGroup", name: "subGroup", create: true, edit: true, list: true, type: "string",  expandtype:"" },
			/*4*/{ field: "Name", name: "Name", create: true, edit: true, list: true, type: "string",  expandtype:"" },
			/*5*/{ field: "Path", name: "Path", create: true, edit: true, list: true, type: "string",  expandtype:"" },
			/*6*/{ field: "Description", name: "Description", create: true, edit: true, list: true, type: "string",  expandtype:"" },
