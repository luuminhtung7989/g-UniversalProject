var _gbSubDictionary = {
	GroupRightDetail : {
		...
		_listReports: [{}],
		_listSelfTables: [
			{ AjaxObj: { a: "fGetGroupRightDetail", _f: "*", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetGroupRightDetail", _f: "Id,GroupID,ParentGroupID,subGroup,Name,Path,Description,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetGroupRightDetail", _f: "Id,GroupID,ParentGroupID,subGroup,Name,Path,Description,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
		],
		_listRefTables: [
		...
		_fieldsList: [
			...
			/*1*/{ field: "GroupID", name: "GroupID", create: true, edit: true, list: true, type: "bigint",  expandtype:"" , allownull:true},
			/*2*/{ field: "ParentGroupID", name: "ParentGroupID", create: true, edit: true, list: true, type: "bigint",  expandtype:"" , allownull:true},
			/*3*/{ field: "subGroup", name: "subGroup", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*4*/{ field: "Name", name: "Name", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*5*/{ field: "Path", name: "Path", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*6*/{ field: "Description", name: "Description", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
		...
		_fieldsSearch: [
			...
			/*1*/{ field: "GroupID", name: "GroupID", create: true, edit: true, list: true, type: "bigint",  expandtype:"" , allownull:true,search:""},
			/*2*/{ field: "ParentGroupID", name: "ParentGroupID", create: true, edit: true, list: true, type: "bigint",  expandtype:"" , allownull:true,search:""},
			/*3*/{ field: "subGroup", name: "subGroup", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*4*/{ field: "Name", name: "Name", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*5*/{ field: "Path", name: "Path", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*6*/{ field: "Description", name: "Description", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
