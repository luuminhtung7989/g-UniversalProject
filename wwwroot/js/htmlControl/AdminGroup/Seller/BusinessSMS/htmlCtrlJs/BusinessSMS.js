var _gbSubDictionary = {
	BusinessSMS : {
		...
		_listReports: [{}],
		_listSelfTables: [
			{ AjaxObj: { a: "fGetBusinessSMS", _f: "*", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetBusinessSMS", _f: "Id,BusinessID,SMSID,ContentName,FormName,Description,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetBusinessSMS", _f: "Id,BusinessID,SMSID,ContentName,FormName,Description,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
		],
		_listRefTables: [
			...
			{ field: "SMSID", mergename: [1], objAjax: { AjaxObj: { a: "fGetSMS", c: { }, _f: "Id,Id",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }
		],
		_fieldsList: [
			...
			/*2*/{ field: "SMSID", name: "SMSID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "SMSID", mergename: [1], objAjax: { AjaxObj: { a: "fGetSMS", c: { }, _f: "Id,Id",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:true},
			/*3*/{ field: "ContentName", name: "ContentName", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*4*/{ field: "FormName", name: "FormName", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
		...
		_fieldsSearch: [
			...
			/*2*/{ field: "SMSID", name: "SMSID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "SMSID", mergename: [1], objAjax: { AjaxObj: { a: "fGetSMS", c: { }, _f: "Id,Id",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:true,search:""},
			/*3*/{ field: "ContentName", name: "ContentName", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*4*/{ field: "FormName", name: "FormName", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
