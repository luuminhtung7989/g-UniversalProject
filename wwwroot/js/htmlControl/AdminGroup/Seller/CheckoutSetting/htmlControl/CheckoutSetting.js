var _gbSubDictionary = {
	CheckoutSetting : {
		...
		_listReports: [{}],
		_listSelfTables: [
			{ AjaxObj: { a: "fGetCheckoutSetting", _f: "*", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetCheckoutSetting", _f: "Id,PointBonus,CheckoutTypeID,BusinessID,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetCheckoutSetting", _f: "Id,PointBonus,CheckoutTypeID,BusinessID,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
		],
		_listRefTables: [
			...
			{ field: "CheckoutTypeID", mergename: [1], objAjax: { AjaxObj: { a: "fGetCheckoutType", c: { }, _f: "Id,Name",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }
		],
		_fieldsList: [
			/*0*/{ field: "Id", name: "Identify", create: true, edit: true, list: true, type: "bigint",  expandtype:"hidden" , allownull:false},
			/*1*/{ field: "PointBonus", name: "PointBonus", create: true, edit: true, list: true, type: "double",  expandtype:"" , allownull:false},
			/*2*/{ field: "CheckoutTypeID", name: "CheckoutTypeID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "CheckoutTypeID", mergename: [1], objAjax: { AjaxObj: { a: "fGetCheckoutType", c: { }, _f: "Id,Name",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:true},
			/*3*/{ field: "BusinessID", name: "BusinessID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "BusinessID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetBusiness", c: { }, _f: "Id,Name,Phone",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:true},
			/*4*/{ field: "isActive", name: "isActive", create: true, edit: true, list: true, type: "int",  expandtype:"" , allownull:false},
		...
		_fieldsSearch: [
			...
			/*1*/{ field: "PointBonus", name: "PointBonus", create: true, edit: true, list: true, type: "double",  expandtype:"" , allownull:false,search:""},
			/*2*/{ field: "CheckoutTypeID", name: "CheckoutTypeID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "CheckoutTypeID", mergename: [1], objAjax: { AjaxObj: { a: "fGetCheckoutType", c: { }, _f: "Id,Name",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:true,search:""},
			/*3*/{ field: "BusinessID", name: "BusinessID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "BusinessID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetBusiness", c: { }, _f: "Id,Name,Phone",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:true,search:""},
			/*4*/{ field: "isActive", name: "isActive", create: true, edit: true, list: true, type: "int",  expandtype:"" , allownull:false,search:""},
