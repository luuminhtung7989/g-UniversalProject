var _gbSubDictionary = {
	CheckoutSetting : {
		...
		_listRefTables: [
			...
			{ field: "CheckoutTypeID", mergename: [1], objAjax: { AjaxObj: { a: "fGetCheckoutType", c: { }, _f: "Id,Name", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }
		],
		_fieldsList: [
			/*0*/{ field: "Id", name: "Identify", create: true, edit: true, list: true, type: "bigint",  expandtype:"hidden" },
			/*1*/{ field: "PointBonus", name: "PointBonus", create: true, edit: true, list: true, type: "double",  expandtype:"" },
			/*2*/{ field: "CheckoutTypeID", name: "CheckoutTypeID", create: true, edit: true, list: true, type: "bigint",  expandtype:"" , option:{ field: "CheckoutTypeID", mergename: [1], objAjax: { AjaxObj: { a: "fGetCheckoutType", c: { }, _f: "Id,Name", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }},
			/*3*/{ field: "BusinessID", name: "BusinessID", create: true, edit: true, list: true, type: "bigint",  expandtype:"" , option:{ field: "BusinessID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetBusiness", c: { }, _f: "Id,Name,Phone", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }},
			/*4*/{ field: "isActive", name: "isActive", create: true, edit: true, list: true, type: "int",  expandtype:"" },
