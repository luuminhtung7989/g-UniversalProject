var _gbSubDictionary = {
	BusinessTime : {
		...
		_fieldsList: [
			...
			/*1*/{ field: "dayth", name: "dayth", create: true, edit: true, list: true, type: "string",  expandtype:"" },
			/*2*/{ field: "opentime", name: "opentime", create: true, edit: true, list: true, type: "datetime",  expandtype:"" },
			/*3*/{ field: "closetime", name: "closetime", create: true, edit: true, list: true, type: "datetime",  expandtype:"" },
			/*4*/{ field: "BusinessID", name: "BusinessID", create: true, edit: true, list: true, type: "bigint",  expandtype:"" , option:{ field: "BusinessID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetBusiness", c: { }, _f: "Id,Name,Phone", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }},
