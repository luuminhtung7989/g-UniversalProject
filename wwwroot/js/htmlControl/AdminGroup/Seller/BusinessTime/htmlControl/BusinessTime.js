var _gbSubDictionary = {
	BusinessTime : {
		...
		_listReports: [{}],
		_listSelfTables: [
			{ AjaxObj: { a: "fGetBusinessTime", _f: "*", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetBusinessTime", _f: "Id,dayth,opentime,closetime,BusinessID,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetBusinessTime", _f: "Id,dayth,opentime,closetime,BusinessID,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
		],
		_listRefTables: [
		...
		_fieldsList: [
			...
			/*1*/{ field: "dayth", name: "dayth", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*2*/{ field: "opentime", name: "opentime", create: true, edit: true, list: true, type: "datetime",  expandtype:"" , allownull:false},
			/*3*/{ field: "closetime", name: "closetime", create: true, edit: true, list: true, type: "datetime",  expandtype:"" , allownull:false},
			/*4*/{ field: "BusinessID", name: "BusinessID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "BusinessID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetBusiness", c: { }, _f: "Id,Name,Phone",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:true},
		...
		_fieldsSearch: [
			...
			/*1*/{ field: "dayth", name: "dayth", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*2*/{ field: "opentime", name: "opentime", create: true, edit: true, list: true, type: "datetime",  expandtype:"" , allownull:false,search:""},
			/*3*/{ field: "closetime", name: "closetime", create: true, edit: true, list: true, type: "datetime",  expandtype:"" , allownull:false,search:""},
			/*4*/{ field: "BusinessID", name: "BusinessID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "BusinessID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetBusiness", c: { }, _f: "Id,Name,Phone",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:true,search:""},
