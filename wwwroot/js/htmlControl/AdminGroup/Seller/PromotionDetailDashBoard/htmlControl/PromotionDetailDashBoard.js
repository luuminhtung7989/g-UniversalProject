var _gbSubDictionary = {
	PromotionDetailDashBoard : {
		...
		_listReports: [{}],
		_listSelfTables: [
			{ AjaxObj: { a: "fGetPromotionDetailDashBoard", _f: "*", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetPromotionDetailDashBoard", _f: "Id,BusinessID,PromotionID,CusomerName,CustomerPhone,NumVisit,TotalDelivered,Income,Expense,Phone,Email,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetPromotionDetailDashBoard", _f: "Id,BusinessID,PromotionID,CusomerName,CustomerPhone,NumVisit,TotalDelivered,Income,Expense,Phone,Email,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
		],
		_listRefTables: [
		...
		_fieldsList: [
			...
			/*3*/{ field: "CusomerName", name: "CusomerName", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*4*/{ field: "CustomerPhone", name: "CustomerPhone", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*5*/{ field: "NumVisit", name: "NumVisit", create: true, edit: true, list: true, type: "int",  expandtype:"" , allownull:false},
			/*6*/{ field: "TotalDelivered", name: "TotalDelivered", create: true, edit: true, list: true, type: "double",  expandtype:"" , allownull:false},
			/*7*/{ field: "Income", name: "Income", create: true, edit: true, list: true, type: "double",  expandtype:"" , allownull:false},
			/*8*/{ field: "Expense", name: "Expense", create: true, edit: true, list: true, type: "double",  expandtype:"" , allownull:false},
			/*9*/{ field: "Phone", name: "Phone", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*10*/{ field: "Email", name: "Phone", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
		...
		_fieldsSearch: [
			...
			/*3*/{ field: "CusomerName", name: "CusomerName", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*4*/{ field: "CustomerPhone", name: "CustomerPhone", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*5*/{ field: "NumVisit", name: "NumVisit", create: true, edit: true, list: true, type: "int",  expandtype:"" , allownull:false,search:""},
			/*6*/{ field: "TotalDelivered", name: "TotalDelivered", create: true, edit: true, list: true, type: "double",  expandtype:"" , allownull:false,search:""},
			/*7*/{ field: "Income", name: "Income", create: true, edit: true, list: true, type: "double",  expandtype:"" , allownull:false,search:""},
			/*8*/{ field: "Expense", name: "Expense", create: true, edit: true, list: true, type: "double",  expandtype:"" , allownull:false,search:""},
			/*9*/{ field: "Phone", name: "Phone", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*10*/{ field: "Email", name: "Phone", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
