var _gbSubDictionary = {
	...
	Customers : {
		...
		_fieldsList: [
			...
			/*6*/{ field: "CustTypeID", name: "CustTypeID", create: true, edit: true, list: true, type: "bigint",  expandtype:"" , option:{ field: "CustTypeID", mergename: [1], objAjax: { AjaxObj: { a: "fGetCustomerType", c: { }, _f: "Id,Id", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }},
