var _gbSubDictionary = {
	...
	Customers : {
		...
		_listReports: [{}],
		_listSelfTables: [
			{ AjaxObj: { a: "fGetCustomers", _f: "*", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetCustomers", _f: "Id,BusinessID,Name,Phone,Email,Birthday,CustTypeID,VisitCount,LifeTimePoint,CurrentPoint,SMSSent,EmailSent,Note,AnniversaryDay,RelationInfo,OcupationInfo,LastVisited,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetCustomers", _f: "Id,BusinessID,Name,Phone,Email,Birthday,CustTypeID,VisitCount,LifeTimePoint,CurrentPoint,SMSSent,EmailSent,Note,AnniversaryDay,RelationInfo,OcupationInfo,LastVisited,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
		],
		_listRefTables: [
			{ field: "BusinessID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetBusiness", c: { }, _f: "Id,Name,Phone",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } },
			{ field: "CustTypeID", mergename: [1], objAjax: { AjaxObj: { a: "fGetCustomerType", c: { }, _f: "Id,Id",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } },
			{ field: "UserID", mergename: [1], objAjax: { AjaxObj: { a: "fGetUsers", c: { }, _f: "Id,UseName",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }
		],
		_fieldsList: [
			/*0*/{ field: "Id", name: "Identify", create: true, edit: true, list: true, type: "bigint",  expandtype:"hidden" , allownull:false},
			...
			/*3*/{ field: "Phone", name: "Phone", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*4*/{ field: "Email", name: "Email", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*5*/{ field: "Birthday", name: "Birthday", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*6*/{ field: "CustTypeID", name: "CustTypeID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "CustTypeID", mergename: [1], objAjax: { AjaxObj: { a: "fGetCustomerType", c: { }, _f: "Id,Id",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:false},
			/*7*/{ field: "VisitCount", name: "VisitCount", create: true, edit: true, list: true, type: "int",  expandtype:"" , allownull:false},
			/*8*/{ field: "LifeTimePoint", name: "LifeTimePoint", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*9*/{ field: "CurrentPoint", name: "CurrentPoint", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*10*/{ field: "SMSSent", name: "SMSSent", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*11*/{ field: "EmailSent", name: "EmailSent", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*12*/{ field: "Note", name: "Note", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*13*/{ field: "AnniversaryDay", name: "AnniversaryDay", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*14*/{ field: "RelationInfo", name: "RelationInfo", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*15*/{ field: "OcupationInfo", name: "OcupationInfo", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*16*/{ field: "LastVisited", name: "LastVisited", create: true, edit: true, list: true, type: "datetime",  expandtype:"" , allownull:false},
			/*17*/{ field: "isActive", name: "isActive", create: true, edit: true, list: true, type: "int",  expandtype:"" , allownull:false},
			/*18*/{ field: "isUserID", name: "isUser", create: true, edit: true, list: true, type: "bigint",  expandtype:"" , allownull:false},
			/*19*/{ field: "isValid", name: "isValid", create: false, edit: false, list: false, type: "int",  expandtype:"" , allownull:false},
			/*20*/{ field: "isCreatedDate", name: "isCreateDated", create: false, edit: false, list: false, type: "datetime",  expandtype:"" , allownull:false},
			/*21*/{ field: "isUpdatedDate", name: "isUpdateDated", create: false, edit: false, list: false, type: "datetime",  expandtype:"" , allownull:false},
			/*22*/{ field: "isPartFull", name: "isPartFull", create: false, edit: false, list: false, type: "string",  expandtype:"" , allownull:false}
		],
		_fieldsReport: [
			/*0*/{ field: "Id", name: "Identify", create: true, edit: true, list: true, type: "bigint",  expandtype:"hidden" , allownull:false},
			/*1*/{ field: "BusinessID", name: "BusinessID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "BusinessID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetBusiness", c: { }, _f: "Id,Name,Phone",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:true},
		...
		_fieldsSearch: [
			...
			/*3*/{ field: "Phone", name: "Phone", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*4*/{ field: "Email", name: "Email", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*5*/{ field: "Birthday", name: "Birthday", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*6*/{ field: "CustTypeID", name: "CustTypeID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "CustTypeID", mergename: [1], objAjax: { AjaxObj: { a: "fGetCustomerType", c: { }, _f: "Id,Id",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:false,search:""},
			/*7*/{ field: "VisitCount", name: "VisitCount", create: true, edit: true, list: true, type: "int",  expandtype:"" , allownull:false,search:""},
			/*8*/{ field: "LifeTimePoint", name: "LifeTimePoint", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*9*/{ field: "CurrentPoint", name: "CurrentPoint", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*10*/{ field: "SMSSent", name: "SMSSent", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*11*/{ field: "EmailSent", name: "EmailSent", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*12*/{ field: "Note", name: "Note", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*13*/{ field: "AnniversaryDay", name: "AnniversaryDay", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*14*/{ field: "RelationInfo", name: "RelationInfo", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*15*/{ field: "OcupationInfo", name: "OcupationInfo", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*16*/{ field: "LastVisited", name: "LastVisited", create: true, edit: true, list: true, type: "datetime",  expandtype:"" , allownull:false,search:""},
			/*17*/{ field: "isActive", name: "isActive", create: true, edit: true, list: true, type: "int",  expandtype:"" , allownull:false,search:""},
			/*18*/{ field: "isUserID", name: "isUser", create: true, edit: true, list: true, type: "bigint",  expandtype:"" , allownull:false,search:"group"},
			/*19*/{ field: "isValid", name: "isValid", create: false, edit: false, list: false, type: "int",  expandtype:"" , allownull:false,search:""},
			/*20*/{ field: "isCreatedDate", name: "isCreateDated", create: false, edit: false, list: false, type: "datetime",  expandtype:"" , allownull:false,search:""},
			/*21*/{ field: "isUpdatedDate", name: "isUpdateDated", create: false, edit: false, list: false, type: "datetime",  expandtype:"" , allownull:false,search:""},
			/*22*/{ field: "isPartFull", name: "isPartFull", create: false, edit: false, list: false, type: "string",  expandtype:"" , allownull:false,search:""}
		],
		_editform: [
			{ row: [0, 1], style: [".col-md-2", ".col-md-4"] },
			{ row: [2, 3], style: [".col-md-2", ".col-md-4"] },
