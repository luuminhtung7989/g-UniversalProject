var _gbSubDictionary = {
	Roles : {
		...
		_listReports: [{}],
		_listSelfTables: [
			{ AjaxObj: { a: "fGetRoles", _f: "*", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetRoles", _f: "Id,UserID,GroupRightID,Permission,SubPermission,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetRoles", _f: "Id,UserID,GroupRightID,Permission,SubPermission,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
		],
		_listRefTables: [
			{ field: "UserID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetUsers", c: { }, _f: "Id,Email,Phone",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } },
			{ field: "GroupRightID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetGroupRights", c: { }, _f: "Id,Name,Code",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }
		],
		_fieldsList: [
			/*0*/{ field: "Id", name: "Identify", create: true, edit: true, list: true, type: "bigint",  expandtype:"hidden" , allownull:false},
			/*1*/{ field: "UserID", name: "UserID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "UserID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetUsers", c: { }, _f: "Id,Email,Phone",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:true},
			/*2*/{ field: "GroupRightID", name: "GroupRightID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "GroupRightID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetGroupRights", c: { }, _f: "Id,Name,Code",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:true},
			/*3*/{ field: "Permission", name: "Permission", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*4*/{ field: "SubPermission", name: "SubPermission", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
		...
		_fieldsSearch: [
			...
			/*1*/{ field: "UserID", name: "UserID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "UserID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetUsers", c: { }, _f: "Id,Email,Phone",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:true,search:""},
			/*2*/{ field: "GroupRightID", name: "GroupRightID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "GroupRightID", mergename: [1,2], objAjax: { AjaxObj: { a: "fGetGroupRights", c: { }, _f: "Id,Name,Code",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:true,search:""},
			/*3*/{ field: "Permission", name: "Permission", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*4*/{ field: "SubPermission", name: "SubPermission", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
	...
	GroupRights : {
		...
		_listReports: [{}],
		_listSelfTables: [
			{ AjaxObj: { a: "fGetGroupRights", _f: "*", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetGroupRights", _f: "Id,ParentGroupID,Code,Name,Path,Description,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetGroupRights", _f: "Id,ParentGroupID,Code,Name,Path,Description,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
		],
		_listRefTables: [
			{ field: "UserID", mergename: [1], objAjax: { AjaxObj: { a: "fGetUsers", c: { }, _f: "Id,UseName",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }
		...
		_fieldsList: [
			/*0*/{ field: "Id", name: "Identify", create: true, edit: true, list: true, type: "bigint",  expandtype:"hidden" , allownull:false},
			/*1*/{ field: "ParentGroupID", name: "ParentGroupID", create: true, edit: true, list: true, type: "bigint",  expandtype:"" , allownull:true},
			/*2*/{ field: "Code", name: "Code", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*3*/{ field: "Name", name: "Name", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*4*/{ field: "Path", name: "Path", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
			/*5*/{ field: "Description", name: "Description", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false},
		...
		_fieldsSearch: [
			/*0*/{ field: "Id", name: "Identify", create: true, edit: true, list: true, type: "bigint",  expandtype:"hidden" , allownull:false,search:""},
			/*1*/{ field: "ParentGroupID", name: "ParentGroupID", create: true, edit: true, list: true, type: "bigint",  expandtype:"" , allownull:true,search:""},
			/*2*/{ field: "Code", name: "Code", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*3*/{ field: "Name", name: "Name", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*4*/{ field: "Path", name: "Path", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
			/*5*/{ field: "Description", name: "Description", create: true, edit: true, list: true, type: "string",  expandtype:"" , allownull:false,search:""},
