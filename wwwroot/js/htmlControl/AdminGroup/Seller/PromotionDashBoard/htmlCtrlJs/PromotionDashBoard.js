var _gbSubDictionary = {
	PromotionDashBoard : {
		...
		_listReports: [{}],
		_listSelfTables: [
			{ AjaxObj: { a: "fGetPromotionDashBoard", _f: "*", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetPromotionDashBoard", _f: "Id,BusinessID,PromotionID,TotalDelivered,Income,Expense,Phone,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
			{ AjaxObj: { a: "fGetPromotionDashBoard", _f: "Id,BusinessID,PromotionID,TotalDelivered,Income,Expense,Phone,isActive,isUserID,isValid,isCreatedDate,isUpdatedDate,isPartFull", _gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" },
		],
		_listRefTables: [
		...
		_fieldsList: [
			...
			/*2*/{ field: "PromotionID", name: "PromotionID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "PromotionID", mergename: [1], objAjax: { AjaxObj: { a: "fGetPromotions", c: { }, _f: "Id,Id",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:true},
			/*3*/{ field: "TotalDelivered", name: "TotalDelivered", create: true, edit: true, list: true, type: "double",  expandtype:"" , allownull:false},
			/*4*/{ field: "Income", name: "Income", create: true, edit: true, list: true, type: "double",  expandtype:"" , allownull:false},
			/*5*/{ field: "Expense", name: "Expense", create: true, edit: true, list: true, type: "double",  expandtype:"" , allownull:false},
		...
		_fieldsSearch: [
			...
			/*2*/{ field: "PromotionID", name: "PromotionID", create: true, edit: true, list: true, type: "bigint",  expandtype:"select" , fkey:true , option:{ field: "PromotionID", mergename: [1], objAjax: { AjaxObj: { a: "fGetPromotions", c: { }, _f: "Id,Id",_gb: " ORDER BY Id Desc", ModelDb: "AppCoreDb" }, APIkey: "kUcHUoWsxLPrIJy$rTcbeG5k" } }, allownull:true,search:""},
			/*3*/{ field: "TotalDelivered", name: "TotalDelivered", create: true, edit: true, list: true, type: "double",  expandtype:"" , allownull:false,search:""},
			/*4*/{ field: "Income", name: "Income", create: true, edit: true, list: true, type: "double",  expandtype:"" , allownull:false,search:""},
			/*5*/{ field: "Expense", name: "Expense", create: true, edit: true, list: true, type: "double",  expandtype:"" , allownull:false,search:""},
